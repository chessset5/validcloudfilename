...
class Test_fileSplit(unittest.TestCase):
    ...
    def test_filesplit0(self):
        self.assertEqual(self.s.fileSplit("apple.txt"), ["apple", ".text"])

    def test_filesplit1(self):
        self.assertEqual(self.s.fileSplit("appletxt"), ["appletext", ""])
...
class Test_oneIncFileName(unittest.TestCase):
    ...
    def test_1ifn1_1(self):
        self.assertEqual(self.s.incFileName("apple(-5)."), "apple(0).")
    ...
    def test_1ifn7(self):
        self.assertEqual(self.s.incFileName(
            "(apple)(0).txt(0)"), "(apple)(0).txt(0)")


class Test_twoIncFileName(unittest.TestCase):
